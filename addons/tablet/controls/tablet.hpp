...
class cTab_RscText_Tablet: cTab_RscText {
	style = ST_CENTER;
	w = QUOTE(pxToScreen_W(cTab_GUI_tablet_OSD_ELEMENT_STD_W));
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_OSD_ELEMENT_STD_H));
	font = QUOTE(GUI_FONT_MONO);
	colorText[] = COLOR_WHITE;
	sizeEx = QUOTE(pxToScreen_H(cTab_GUI_tablet_OSD_TEXT_STD_SIZE));
	colorBackground[] = COLOR_TRANSPARENT;
	shadow = 0;
};
class cTab_RscListbox_Tablet: cTab_RscListBox {
	sizeEx = QUOTE(pxToScreen_H(cTab_GUI_tablet_OSD_TEXT_STD_SIZE * 1.2));
};
...
class cTab_tablet_header: cTab_RscPicture {
	...
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_OSD_HEADER_H));
};
class cTab_Tablet_OSD_battery: cTab_RscPicture {
	
	idc = 2;
	text = QPATHTOF(ui\icon_battery_ca.paa);
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(1)));
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_MAP_Y + (cTab_GUI_tablet_OSD_HEADER_H - cTab_GUI_tablet_OSD_ICON_STD_SIZE) / 2));
	w = QUOTE(pxToScreen_W(cTab_GUI_tablet_OSD_ICON_STD_SIZE));
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_OSD_ICON_STD_SIZE));
	colorText[] = COLOR_WHITE;
};
class cTab_Tablet_OSD_time: cTab_RscText_Tablet {
	idc = IDC_CTAB_OSD_TIME;
	style = ST_CENTER;
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(4)));
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_MAP_Y + (cTab_GUI_tablet_OSD_HEADER_H - cTab_GUI_tablet_OSD_TEXT_STD_SIZE) / 2));
};
class cTab_Tablet_OSD_signalStrength: cTab_Tablet_OSD_battery {
	idc = 3;
	text = QPATHTOF(ui\icon_signalStrength_ca.paa);
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(7) + cTab_GUI_tablet_OSD_ELEMENT_STD_W - cTab_GUI_tablet_OSD_ICON_STD_SIZE * 2));
	colorText[] = COLOR_WHITE;
};
class cTab_Tablet_OSD_satellite: cTab_Tablet_OSD_battery {
	idc = 4;
	text = "\a3\ui_f\data\map\Diary\signal_ca.paa";
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(7) + cTab_GUI_tablet_OSD_ELEMENT_STD_W - cTab_GUI_tablet_OSD_ICON_STD_SIZE));
	colorText[] = COLOR_WHITE;
};
class cTab_Tablet_OSD_dirDegree: cTab_Tablet_OSD_time {
	idc = IDC_CTAB_OSD_DIR_DEGREE;
	style = ST_LEFT;
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(2)));
};
class cTab_Tablet_OSD_grid: cTab_Tablet_OSD_dirDegree {
	idc = IDC_CTAB_OSD_GRID;
	style = ST_RIGHT;
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_X(6)));
};
...
class cTab_Tablet_window_back_TL: cTab_RscPicture {
	text = QPATHTOF(ui\window_2.jpg);
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_WINDOW_BACK_L_X));
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_WINDOW_BACK_T_Y));
	w = QUOTE(pxToScreen_W(cTab_GUI_tablet_WINDOW_BACK_W));
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_WINDOW_BACK_H));
};
class cTab_Tablet_window_back_BL: cTab_Tablet_window_back_TL {
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_WINDOW_BACK_B_Y));
};
class cTab_Tablet_window_back_TR: cTab_Tablet_window_back_TL {
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_WINDOW_BACK_R_X));
};
class cTab_Tablet_window_back_BR: cTab_Tablet_window_back_TR {
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_WINDOW_BACK_B_Y));
};
class cTab_Tablet_btnF1: cTab_RscButtonInv {
	x = QUOTE(pxToScreen_X(506));
	y = QUOTE(pxToScreen_Y(1545));
	w = QUOTE(pxToScreen_W(52));
	h = QUOTE(pxToScreen_H(52));
};
class cTab_Tablet_btnF2: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(569));
};
class cTab_Tablet_btnF3: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(639));
};
class cTab_Tablet_btnF4: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(703));
};
class cTab_Tablet_btnF5: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(768));
};
class cTab_Tablet_btnF6: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(833));
};
class cTab_Tablet_btnFn: cTab_Tablet_btnF1 {
	x = QUOTE(pxToScreen_X(970));
};
class cTab_Tablet_btnPower: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1034));
};
class cTab_Tablet_btnBrtDn: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1100));
};
class cTab_Tablet_btnBrtUp: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1163));
};
class cTab_Tablet_btnTrackpad: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1262));
	y = QUOTE(pxToScreen_Y(1550));
	w = QUOTE(pxToScreen_W(48));
	h = QUOTE(pxToScreen_H(43));
};
class cTab_Tablet_btnMouse: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1401));
	w = QUOTE(pxToScreen_W(91));
};
class cTab_Tablet_btnHome: cTab_Tablet_btnMouse {
	x = QUOTE(pxToScreen_X(897));
	y = QUOTE(pxToScreen_Y(1534));
	w = QUOTE(pxToScreen_W(61));
	h = QUOTE(pxToScreen_H(49));
};
class cTab_Tablet_notificationLight {
	x = QUOTE(pxToScreen_X(1353));
	y = QUOTE(pxToScreen_Y(1557));
	w = QUOTE(pxToScreen_W(28));
	h = QUOTE(pxToScreen_H(28));
};
class cTab_Tablet_btnRtf42: cTab_Tablet_btnFn {
	x = QUOTE(pxToScreen_X(1451));
};
class cTab_Tablet_OSD_hookGrid: cTab_RscText_Tablet {
	idc = IDC_CTAB_OSD_HOOK_GRID;
	style = ST_CENTER;
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_OSD_RIGHT_X));
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_OSD_EDGE_B - cTab_GUI_tablet_OSD_MARGIN - cTab_GUI_tablet_OSD_ELEMENT_STD_H * 4));
	colorText[] = {1,1,1,0.5};
	colorBackground[] = {0,0,0,0.25};
};
class cTab_Tablet_OSD_hookElevation: cTab_Tablet_OSD_hookGrid {
	idc = IDC_CTAB_OSD_HOOK_ELEVATION;
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_OSD_EDGE_B - cTab_GUI_tablet_OSD_MARGIN - cTab_GUI_tablet_OSD_ELEMENT_STD_H * 3));
};
class cTab_Tablet_OSD_hookDst: cTab_Tablet_OSD_hookGrid {
	idc = IDC_CTAB_OSD_HOOK_DST;
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_OSD_EDGE_B - cTab_GUI_tablet_OSD_MARGIN - cTab_GUI_tablet_OSD_ELEMENT_STD_H * 2));
};
class cTab_Tablet_OSD_hookDir: cTab_Tablet_OSD_hookGrid {
	idc = IDC_CTAB_OSD_HOOK_DIR;
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_OSD_EDGE_B - cTab_GUI_tablet_OSD_MARGIN - cTab_GUI_tablet_OSD_ELEMENT_STD_H));
};
...
class cTab_Tablet_movingHandle_T: cTab_RscText_Tablet {
	...
	moving = 1;
	colorBackground[] = COLOR_TRANSPARENT;
	x = QUOTE(pxToScreen_X(0));
	y = QUOTE(pxToScreen_Y(0));
	w = QUOTE(pxToScreen_W(GUI_GRID_PX_W));
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_MAP_Y));
};
class cTab_Tablet_movingHandle_B: cTab_Tablet_movingHandle_T {
	idc = 6;
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_MAP_Y + cTab_GUI_tablet_MAP_H));
	h = QUOTE(pxToScreen_H(GUI_GRID_PX_H - (cTab_GUI_tablet_MAP_Y + cTab_GUI_tablet_MAP_H)));
};
class cTab_Tablet_movingHandle_L: cTab_Tablet_movingHandle_T {
	idc = 7;
	y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_MAP_Y));
	w = QUOTE(pxToScreen_W(cTab_GUI_tablet_MAP_X));
	h = QUOTE(pxToScreen_H(cTab_GUI_tablet_MAP_H));
};
class cTab_Tablet_movingHandle_R: cTab_Tablet_movingHandle_L {
	idc = 8;
	x = QUOTE(pxToScreen_X(cTab_GUI_tablet_MAP_X + cTab_GUI_tablet_MAP_W));
	w = QUOTE(pxToScreen_W(GUI_GRID_PX_W - (cTab_GUI_tablet_MAP_X + cTab_GUI_tablet_MAP_W)));
};
...
class cTab_Tablet_RscMapControl: cTab_RscMapControl {
	...
	ptsPerSquareSea = QUOTE(8 / (0.86 / GUI_GRID_H));
...
class cTab_Tablet_notification: cTab_RscText_Tablet {
    ...
    x = QUOTE(pxToScreen_X(cTab_GUI_tablet_SCREEN_CONTENT_X + (cTab_GUI_tablet_SCREEN_CONTENT_W * 0.5) / 2));
    y = QUOTE(pxToScreen_Y(cTab_GUI_tablet_SCREEN_CONTENT_Y + cTab_GUI_tablet_SCREEN_CONTENT_H - 2 * cTab_GUI_tablet_OSD_TEXT_STD_SIZE));
    w = QUOTE(pxToScreen_W(cTab_GUI_tablet_SCREEN_CONTENT_W * 0.5));
