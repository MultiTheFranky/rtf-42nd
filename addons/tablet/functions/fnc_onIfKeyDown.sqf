...
/*
	...
	Parameters:
 	...
 	Example:
		[_display,_dikCode,_shiftKey,_ctrlKey,_altKey] call FUNC(onIfKeyDown);
*/

#include "..\macros\dikCodes.h"
...
if (_dikCode == DIK_F6 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg","cTab_TAD_dlg","cTab_microDAGR_dlg","cTab_FBCB2_dlg"]}) exitWith {
	[_displayName] call FUNC(mapType_toggle);
	true
};
...
if (_dikCode == DIK_F8 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg","cTab_TAD_dlg","cTab_microDAGR_dlg","cTab_FBCB2_dlg"]}) exitWith {
	[_displayName,[["mode","RTF42"]]] call FUNC(setSettings);
	true
};
