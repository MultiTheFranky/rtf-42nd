class RscDisplayLoadMission: RscStandardDisplay {
    onLoad = "[654,(_this) select 0,'RscDisplayLoadMission',true] call (uiNamespace getVariable 'rtf42_ui_fnc_setRandomBackground');[999,(_this) select 0,'RscDisplayLoadMission',true] call (uiNamespace getVariable 'rtf42_ui_fnc_setRandomBackground');[1201,(_this) select 0,'RscDisplayLoadMission',true] call (uiNamespace getVariable 'rtf42_ui_fnc_setRandomBackground');['onLoad',_this,'RscDisplayLoading','Loading'] call (uiNamespace getVariable 'rtf42_ui_fnc_missionLoad');";
    onUnload = "['onUnload',_this,'RscDisplayLoading','Loading'] call  (uiNamespace getVariable 'rtf42_ui_fnc_missionLoad')";
