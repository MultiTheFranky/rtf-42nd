class RscDisplayNotFreeze: RscStandardDisplay {
    onLoad = "[102,(_this) select 0,'RscDisplayNotFreeze',true] call (uiNamespace getVariable 'rtf42_ui_fnc_setRandomBackground');[1201,(_this) select 0,'RscDisplayNotFreeze',true] call (uiNamespace getVariable 'rtf42_ui_fnc_setRandomBackground');['onLoad',_this,'RscDisplayLoading','Loading'] call (uiNamespace getVariable 'rtf42_ui_fnc_missionLoad');[] spawn {while {!(isnil 'BIS_fnc_preload_server') && {!(call BIS_fnc_preload_server)}} do {sleep 1;};endLoadingScreen;}";
