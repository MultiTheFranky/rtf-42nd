class GVAR(officer): B_CTRG_soldier_GL_LAT_F {
    ...
    linkedItems[] = {QEGVAR(vests,officer),"rhsusf_mich_bare_norotos_alt_tan","rhsusf_oakley_goggles_clr",QEGVAR(weapons,officer_binoculars),"ItemMap","rtf42_tablet_Tablet","ItemRadio","ItemCompass","ACE_Altimeter","rhsusf_ANPVS_15"};
    respawnLinkedItems[] = {QEGVAR(vests,officer),"rhsusf_mich_bare_norotos_alt_tan","rhsusf_oakley_goggles_clr",QEGVAR(weapons,officer_binoculars),"ItemMap","rtf42_tablet_Tablet","ItemRadio","ItemCompass","ACE_Altimeter","rhsusf_ANPVS_15"};
