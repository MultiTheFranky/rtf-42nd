class GVAR(sl): tweed_acu_summer_ocp_crye_knee {
    ...
    linkedItems[] = {QEGVAR(vests,sl),"rhsusf_mich_bare_norotos_alt","G_tweed_tacticool_weiss_oak",QEGVAR(weapons,sl_binoculars),"ItemMap","ItemAndroid","TFAR_anprc152","ItemCompass","ACE_Altimeter"};
    respawnLinkedItems[] = {QEGVAR(vests,sl),"rhsusf_mich_bare_norotos_alt","G_tweed_tacticool_weiss_oak",QEGVAR(weapons,sl_binoculars),"ItemMap","ItemAndroid","TFAR_anprc152","ItemCompass","ACE_Altimeter"};
