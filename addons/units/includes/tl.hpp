class GVAR(tl): tweed_acu_summer_ocp_crye_knee {
    ...
    weapons[] = {QEGVAR(weapons,tl_primaryWeapon),QEGVAR(weapons,tl_secondaryWeapon),"Throw","Put"};
    respawnWeapons[] = {QEGVAR(weapons,tl_primaryWeapon),QEGVAR(weapons,tl_secondaryWeapon),"Throw","Put"};
    uniformClass = QEGVAR(uniforms,tl);
    backpack = QEGVAR(backpacks,tl);
    linkedItems[] = {QEGVAR(vests,tl),"3DMA_WD_Opscore_V5","G_tweed_tacticool_weiss_oak",QEGVAR(weapons,tl_binoculars),"ItemMap","ItemMicroDAGR","TFAR_rf7800str","ItemCompass","ACE_Altimeter"};
    respawnLinkedItems[] = {QEGVAR(vests,tl),"3DMA_WD_Opscore_V5","G_tweed_tacticool_weiss_oak",QEGVAR(weapons,tl_binoculars),"ItemMap","ItemMicroDAGR","TFAR_rf7800str","ItemCompass","ACE_Altimeter"};
