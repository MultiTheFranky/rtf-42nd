class CfgVehicles {
    ...
    class rhsusf_m1043_d: rhsusf_m1043_w {
        ...
        editorSubcategory = QEGVAR(main,Vehicles);
    ...
    class CUP_B_nM997_DF_USA_DES;
    class GVAR(b_nm997_df_usa_des): CUP_B_nM997_DF_USA_DES {
    ...
    class GVAR(b_m252_us): CUP_B_M252_US {
        artilleryScanner = 0;
        faction = QEGVAR(main,Faction);
