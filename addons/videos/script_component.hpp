#define COMPONENT videos
#define COMPONENT_BEAUTIFIED Videos
...
#ifdef DEBUG_ENABLED_VIDEOS
    #define DEBUG_MODE_FULL
#endif

#ifdef DEBUG_SETTINGS_VIDEOS
    #define DEBUG_SETTINGS DEBUG_SETTINGS_VIDEOS
#endif
