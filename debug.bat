...
rem =========ZONE TO EDIT========
rem Define Disk
set ARMA3_PARAMS=-mod="!Workshop\@CBA_A3;!Workshop\@ace;!Workshop\@RHSUSAF;!Workshop\@Zeus Enhanced;!Workshop\@Zeus Enhanced - ACE3 Compatibility;!Workshop\@CUP Units;!Workshop\@CUP Weapons;!Workshop\@CUP Vehicles;z\rtf42" -noSplash -showScriptErrors -noPause -world=empty
