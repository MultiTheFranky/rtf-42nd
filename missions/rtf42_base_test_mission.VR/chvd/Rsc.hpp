...
class CHVD_dialog
{
	...
	class controls
	{
		class CHVD_rscFootViewSlider: CHVD_rscXSliderH
		{
			idc = 1900;
			type = 43;
			onSliderPosChanged = "['CHVD_foot', _this select 0, _this select 1, 1006, 'CHVD_footObj', 1901, 1007, 'CHVD_footSyncMode', 'CHVD_footSyncPercentage'] call CHVDAddon_fnc_onSliderChange";
		...
		class CHVD_rscCarViewSlider: CHVD_rscXSliderH
		{
			idc = 1902;
			type = 43;
			onSliderPosChanged = "['CHVD_car', _this select 0, _this select 1, 1013, 'CHVD_carObj', 1903, 1014, 'CHVD_carSyncMode', 'CHVD_carSyncPercentage'] call CHVDAddon_fnc_onSliderChange";
		...
		class CHVD_rscAirViewSlider: CHVD_rscXSliderH
		{
			idc = 1904;
			type = 43;
			onSliderPosChanged = "['CHVD_air', _this select 0, _this select 1, 1017, 'CHVD_airObj', 1905, 1018, 'CHVD_airSyncMode', 'CHVD_airSyncPercentage'] call CHVDAddon_fnc_onSliderChange";
		...
		{
			idc = 1006;
			onKeyDown = "['CHVD_foot', 1900, _this select 0, 'CHVD_footObj', 1901, 1007, 'CHVD_footSyncMode', 'CHVD_footSyncPercentage'] call CHVDAddon_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1013;
			onKeyDown = "['CHVD_car', 1902, _this select 0, 'CHVD_carObj', 1903, 1014, 'CHVD_carSyncMode', 'CHVD_carSyncPercentage'] call CHVDAddon_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1017;
			onKeyDown = "['CHVD_air', 1904, _this select 0, 'CHVD_airObj', 1905, 1018, 'CHVD_airSyncMode', 'CHVD_airSyncPercentage'] call CHVDAddon_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1400;
			onKeyDown = "['CHVD_footTerrain', 1400, 1500] call CHVDAddon_fnc_onEBterrainInput";
			maxChars = 5;
		...
		{
			idc = 1401;
			onKeyDown = "['CHVD_carTerrain', 1401, 1501] call CHVDAddon_fnc_onEBterrainInput";
			maxChars = 5;
		...
		{
			idc = 1402;
			onKeyDown = "['CHVD_airTerrain', 1402, 1502] call CHVDAddon_fnc_onEBterrainInput";
			maxChars = 5;
