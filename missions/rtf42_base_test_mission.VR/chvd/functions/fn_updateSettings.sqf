...
switch (_updateType) do {
	...
	case 4: {
		switch (CHVD_vehType) do {
			case 0: {setObjectViewDistance ([CHVD_footObj] call CHVDAddon_fnc_fovViewDistance)};
			case 1: {setObjectViewDistance ([CHVD_carObj] call CHVDAddon_fnc_fovViewDistance)};
			case 2: {setObjectViewDistance ([CHVD_airObj] call CHVDAddon_fnc_fovViewDistance)};
		};
	};
	default {
		switch (CHVD_vehType) do {
